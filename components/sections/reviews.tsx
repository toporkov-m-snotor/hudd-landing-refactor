...
function ReviewCard(props: ReviewCardProps) {
  ...
  return (
    <div className="glass-border bg-brand-surface rounded-2xl p-6 w-72 sm:w-80 shrink-0">
      ...
      <h3 className="font-semibold text-brand-text mt-3 mb-2 text-sm leading-snug">
        {review.title}
      </h3>
  ...
  return (
    <section className="py-24 sm:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <FadeIn>
          <SectionHeader
            label="Våre anmeldelser"
            title="Det folk sier om Hudd."
          />
        </FadeIn>
      </div>
      ...
      <div className="relative">
        ...
        <div className="flex overflow-hidden">
          ...
          >
            {[...reviews.slice(2), ...reviews, ...reviews.slice(0, 3)].map(
              (review, i) => (
